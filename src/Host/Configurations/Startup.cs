...
internal static class Startup
{
    internal static WebApplicationBuilder AddConfigurations(this WebApplicationBuilder builder)
    {
        ...
        builder.Configuration.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                ...
                .AddJsonFile($"{configurationsDirectory}/elsa.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/elsa.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
                ...
                .AddJsonFile($"{configurationsDirectory}/seo.json", optional: false, reloadOnChange: true)
                .AddJsonFile($"{configurationsDirectory}/seo.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
